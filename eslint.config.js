...
const crossBoundaryZones = [
  {
    // importer under a host layer importing src/client code
    target: "./src/client",
...
export default defineConfig([
  globalIgnores(["node_modules", "lib", "coverage", "dist", ".husky", ".remember"]),
  {
    ...
    rules: {
      ...
      // Underscore-prefixed function args are deliberately unused (e.g. the
      // `_props`/`_args` placeholders generated by scripts/create-slice.mjs).
